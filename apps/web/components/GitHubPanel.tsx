            ...
            {connection ? (
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="w-full rounded border border-[var(--line)] bg-transparent p-2 text-sm text-[var(--text)] focus:border-[var(--accent)] focus:outline-none"
                >
                  {repos.map(r => (
                  ...
                  <div className="space-y-3 rounded border border-[var(--line-strong)] bg-white/5 p-3">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded border border-[var(--line)] bg-transparent p-2 text-sm text-[var(--text)] focus:border-[var(--accent)] focus:outline-none"
                      />
                    </div>
