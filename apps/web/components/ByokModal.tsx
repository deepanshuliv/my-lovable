        ...
        <div className="space-y-5 p-6">
          <label className="block">
            ...
            <select
              ...
              className="w-full rounded-xl border px-4 py-3 text-[14px] font-medium text-white outline-none focus:border-[var(--accent)] transition-colors"
          ...
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-xl border px-4 py-3 font-mono text-[13px] text-white outline-none placeholder:text-white/20 focus:border-[var(--accent)] transition-colors"
              style={{ borderColor: 'var(--line)', background: 'var(--panel-2)' }}
            />
          </label>
          ...
          <label className="block">
            ...
            <select
              ...
              className="w-full rounded-xl border px-4 py-3 font-mono text-[13px] text-white outline-none focus:border-[var(--accent)] transition-colors"
              style={{ borderColor: 'var(--line)', background: 'var(--panel-2)' }}
            >
              {available.map((m) => (
