      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="relative max-w-sm w-full">
          ...
          <input
            ...
            className="w-full rounded-lg border bg-[var(--panel)] py-2 pl-10 pr-4 text-[13px] outline-none transition-colors focus:border-[var(--line-strong)] focus:bg-[var(--panel-hover)]"
              ...
              <div className="p-4">
                {editing === project.id ? (
                  <input
                    ...
                    className="w-full rounded-md border px-3 py-1.5 text-[14px] outline-none"
                    style={{
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {editing === project.id ? (
                        <input
                          ...
                          className="w-full max-w-xs rounded-md border px-3 py-1.5 text-[14px] outline-none"
                          style={{
                            borderColor: 'var(--accent)',
                            background: 'var(--panel-2)',
                            color: 'var(--text)',
